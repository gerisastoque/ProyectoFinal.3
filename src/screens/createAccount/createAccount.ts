...
import createForm, { Attribute as createFormAttribute } from '../../components/createAccount-form/createAccount-form';
import lowerMenu, { Attribute as lowerMenuAttribute } from '../../components/lower-menu/lower-menu';
...
class CreateAccount extends HTMLElement {
	...
	async render() {
		...
		this.createFormElement = this.ownerDocument.createElement('create-form') as createForm;
		...
		Button.addEventListener('click', async () => {
			if (this.createFormElement) {
				...
				const reenterPasswordInput = this.createFormElement.getReenterPasswordInput();
		...
		const lowerMenuElement = this.ownerDocument.createElement('lower-menu') as createForm;
